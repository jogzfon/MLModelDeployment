...
with c1:
    st.info('**GitHub:[@jogzfon](https://github.com/jogzfon)**', icon="🧠")
with c2:
    st.info('**Kaggle:[@Sheer Jay Piodos](https://www.kaggle.com/shrivernrennassies)**', icon="💻")
with c3:
    st.info('**LinkedIn:[@Sheer Jay Piodos](https://www.linkedin.com/in/sheer-jay-piodos-87711329a/)**', icon="👨‍💼")
